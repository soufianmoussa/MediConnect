...
Route::get('/product/{id}/alternatives', [ProductpageController::class, 'showAlternatives'])->name('product.alternatives');

Route::get('/api/nearby-pharmacies', [PharmacieController::class, 'nearby']);
